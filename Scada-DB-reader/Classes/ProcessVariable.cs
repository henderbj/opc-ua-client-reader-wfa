...
namespace Scada_DB_reader.Classes
{
    public class ProcessVariable
    {
        ...
        public ProcessVariable Find(int VariableId)
        {
            ProcessVariable processVariable = new ProcessVariable();
            SqlConnection con = new SqlConnection(connectionString);
            var cmd = new SqlCommand("SELECT VariableId, ProcessId, VariableName, EngineeringUnit, VariableDescription FROM dbo.ProcessVariable WHERE VariableId = @VariableId", con);
