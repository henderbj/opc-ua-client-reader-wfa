...
namespace Scada_DB_reader.Classes
{
    public class SensorType
    {
        ...
        public SensorType Find(int sensorTypeId)
        {
            SensorType sensorType = new SensorType();
            SqlConnection con = new SqlConnection(connectionString);
            var cmd = new SqlCommand("SELECT SensorTypeID, SensorTypeName, SensorTypeDescription FROM dbo.SensorType WHERE SensorTypeId = @SensorTypeId", con);
